...
var render = function () {
    ...
    if (finished == true) {
        ...
        var img1Ready=false;
		var img1=new Image();
		img1Ready.onload=function(){
			img1Ready=true;
			};	
			if (monstersCaught <= 10) {
				img1.src="images/Picture1.png"
				}
			else if (monstersCaught > 10 && monstersCaught <= 20) {
				img1.src="images/Picture2.png"
				}
			else if (monstersCaught > 20 && monstersCaught <= 30) {
				if (monstersCaught == 28){
					img1.src="images/Picture7.png"
					}
				else {
					img1.src="images/Picture3.png"	
					}
				}
			else if (monstersCaught > 30 && monstersCaught <= 40) {
				img1.src="images/Picture4.png"
				}
			else if (monstersCaught > 40 && monstersCaught <= 50) {
				img1.src="images/Picture5.png"
				}
			else if (monstersCaught > 50) {
				img1.src="images/Picture6.png"
				}		
...
var count = 40; //how many seconds the game lasts for
var finished = false;
